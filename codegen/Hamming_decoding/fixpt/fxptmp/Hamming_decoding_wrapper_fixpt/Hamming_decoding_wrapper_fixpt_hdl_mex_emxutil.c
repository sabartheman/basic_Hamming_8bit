 ...
 *
 * Code generation for function 'Hamming_decoding_wrapper_fixpt_hdl_mex_emxutil'
 *
 */
...
static void emxFreeStruct_struct1_T(struct1_T *pStruct)
{
  emxFree_uint8_T(&pStruct->input_encoded);
}

static void emxFreeStruct_struct2_T(struct2_T *pStruct)
{
  emxFree_uint8_T(&pStruct->output);
  emxFree_uint8_T(&pStruct->errorPosition);
}

static void emxInitStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_uint8_T(sp, &pStruct->input_encoded, 2, srcLocation, doPush);
}

static void emxInitStruct_struct2_T(const emlrtStack *sp, struct2_T *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_uint8_T(sp, &pStruct->output, 2, srcLocation, doPush);
  emxInit_uint8_T(sp, &pStruct->errorPosition, 2, srcLocation, doPush);
}
...
/* End of code generation (Hamming_decoding_wrapper_fixpt_hdl_mex_emxutil.c) */
