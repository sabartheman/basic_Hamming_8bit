 ...
 *
 * Code generation for function 'Hamming_decoding_wrapper_fixpt_hdl_mex_initialize'
 *
 */
...
static void c_Hamming_decoding_wrapper_fixp(const emlrtStack *sp);
...
static void c_Hamming_decoding_wrapper_fixp(const emlrtStack *sp)
{
  ...
  st.site = NULL;
  c_Hamming_decoding_fixpt_logger();
  st.site = NULL;
  input_encoded_TB_logger_init(&st);
  st.site = NULL;
  output_TB_logger_init(&st);
  st.site = NULL;
  errorPosition_TB_logger_init(&st);
}
  ...
  real_T qb, const char * rb, real_T sb, emlrtMCInfo *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &m8, 42, pArrays, "fimath", true, location);
}
  ...
  char * n, real_T o, emlrtMCInfo *location)
{
  ...
  pArrays[12] = emlrtCreateString(n);
  pArrays[13] = emlrtCreateDoubleScalar(o);
  return emlrtCallMATLABR2012b(sp, 1, &m7, 14, pArrays, "numerictype", true,
    location);
}

void Hamming_decoding_wrapper_fixpt_hdl_mex_initialize(void)
{
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    c_Hamming_decoding_wrapper_fixp(&st);
  }
}

/* End of code generation (Hamming_decoding_wrapper_fixpt_hdl_mex_initialize.c) */
